	...
	public unsafe class Entity
	{
		...
		*((int *)this.entity->pvPrivateData + offset) = value;
		...
		public bool Brightfield {
			get { return GetEffect(Effects.Brightfield); }
			set { SetEffect(Effects.Brightfield, value); }
		}

		public bool Muzzleflash {
			get { return GetEffect(Effects.Muzzleflash); }
			set { SetEffect(Effects.Muzzleflash, value); }
		}

		public bool Brightlight {
			get { return GetEffect(Effects.Brightlight); }
			set { SetEffect(Effects.Brightlight, value); }
		}

		public bool Dimlight {
			get { return GetEffect(Effects.Dimlight); }
			set { SetEffect(Effects.Dimlight, value); }
		}

		public bool Invisiblelight {
			get { return GetEffect(Effects.Invisiblelight); }
			set { SetEffect(Effects.Invisiblelight, value); }
		}

		public bool Nointerpolate {
			get { return GetEffect(Effects.Nointerpolate); }
			set { SetEffect(Effects.Nointerpolate, value); }
		}

		public bool Light {
			get { return GetEffect(Effects.Light); }
			set { SetEffect(Effects.Light, value); }
		}

		public bool Nodraw {
			get { return GetEffect(Effects.Nodraw); }
			set { SetEffect(Effects.Nodraw, value); }
		}
